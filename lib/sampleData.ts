...
const sampleTeams = [
  { name: 'Margate Krakens', color: '#1f2937', logo: 'https://margatekrakens.co.uk/assets/images/image01.svg?v=d59198d8' },
  { name: 'Kent Exiles A', color: '#000000', logo: 'https://kentexiles.co.uk/wp-content/uploads/2018/09/logo.png' },
  { name: 'Kent Exiles B', color: '#6b7280', logo: 'https://kentexiles.co.uk/wp-content/uploads/2018/09/logo.png' },
